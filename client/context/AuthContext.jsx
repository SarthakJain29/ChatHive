...
export const AuthProvider = ({children}) => {
    ...
    //check if the user is autheticated and if so, set the user data and connect socket
    const checkAuth = async ()=>{
        try {
            const { data } = await axios.get("/api/auth/check");
            if(data.success){
                setAuthUser(data.user); //setting auth user if user is authenticated
    ...
    //to handle user profile updates
    ...
    //connect socket function to handle connection and online user updates
